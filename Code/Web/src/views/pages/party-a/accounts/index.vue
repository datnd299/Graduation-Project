<template>
  <div>
    ...
    <v-btn @click="toggleAccModal()" large color="primary">
    ...
    >
      <template v-slot:item.role="{ item }">
        <v-chip
          ...
          label
          text-color="white"
        >{{item.role|roleStatusText}}</v-chip>
      </template>
      <template v-slot:item.status="{ item }">
        <v-chip
          ...
          label
          text-color="white"
        >{{item.status|partyStatusText}}</v-chip>
      </template>
